.class public final Lradiant/gestures/queue/PlaylistItemsResolver;
...
.method private constructor <init>(Lcom/aspiro/wamp/playlist/ui/items/PlaylistItemCollectionView;)V
    ...
    iput-object v0, p0, Lradiant/gestures/queue/PlaylistItemsResolver;->recycler:Ljava/lang/ref/WeakReference;
...
.method private current(Lradiant/gestures/queue/QueueRequest;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Lradiant/gestures/queue/PlaylistItemsResolver;->recycler:Ljava/lang/ref/WeakReference;
    ...
    :member_identity
    invoke-static {v0}, Lradiant/gestures/queue/PlaylistItemsResolver;->track(Ljava/lang/Object;)Lcom/aspiro/wamp/model/Track;
    move-result-object v0
    invoke-static {v2}, Lradiant/gestures/queue/PlaylistItemsResolver;->track(Ljava/lang/Object;)Lcom/aspiro/wamp/model/Track;
    ...
    iget-object v4, v1, Lcom/aspiro/wamp/playlist/ui/items/PlaylistItemCollectionView;->d:Lcom/aspiro/wamp/model/AvailabilityInteractor;    # MARKER: R8 d
    if-eqz v4, :invalid
...
.method public static install(Lcom/aspiro/wamp/playlist/ui/items/PlaylistItemCollectionView;)V
    ...
    if-eqz p0, :done
    new-instance v0, Lradiant/gestures/queue/PlaylistItemsResolver;
    invoke-direct {v0, p0}, Lradiant/gestures/queue/PlaylistItemsResolver;-><init>(Lcom/aspiro/wamp/playlist/ui/items/PlaylistItemCollectionView;)V
...
.method private playlistIndex(Lradiant/gestures/queue/QueueRequest;)I
    .locals 6

    iget-object v0, p0, Lradiant/gestures/queue/PlaylistItemsResolver;->recycler:Ljava/lang/ref/WeakReference;
    ...
    move-result-object v0
    instance-of v1, v0, La50/b;    # MARKER: R8 La50/b;
    if-eqz v1, :invalid
    check-cast v0, La50/b;    # MARKER: R8 La50/b;
    iget-object v0, v0, La50/b;->b:Ljava/util/ArrayList;    # MARKER: R8 La50/b; b
...
.method public execute(Lradiant/gestures/queue/QueueRequest;)V
    ...
    invoke-direct {p0, p1}, Lradiant/gestures/queue/PlaylistItemsResolver;->current(Lradiant/gestures/queue/QueueRequest;)Ljava/lang/Object;
    move-result-object v0
    if-eqz v0, :done
    invoke-static {v0}, Lradiant/gestures/queue/PlaylistItemsResolver;->track(Ljava/lang/Object;)Lcom/aspiro/wamp/model/Track;
    move-result-object v1
    ...
    iget-object v2, p0, Lradiant/gestures/queue/PlaylistItemsResolver;->recycler:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v4}, Lcom/aspiro/wamp/util/h0;->c(I)Ljava/lang/String;    # MARKER: R8 Lcom/aspiro/wamp/util/h0; c
    move-result-object v4
    iget-object v5, v2, Lcom/aspiro/wamp/playlist/ui/items/PlaylistItemCollectionView;->h:Lcom/tidal/android/navigation/NavigationInfo;    # MARKER: R8 h
    ...
    invoke-static {v3, v4, v5, v6}, Lcom/aspiro/wamp/playqueue/source/model/b;->j(Ljava/lang/String;Ljava/lang/String;Lcom/tidal/android/navigation/NavigationInfo;Lcom/aspiro/wamp/playqueue/source/model/ItemSource$NavigationType;)Lcom/aspiro/wamp/playqueue/source/model/ItemSource;    # MARKER: R8 Lcom/aspiro/wamp/playqueue/source/model/b; j
    ...
    :append_member
    iget-object v3, v2, Lcom/aspiro/wamp/playlist/ui/items/PlaylistItemCollectionView;->c:Lcom/aspiro/wamp/playlist/ui/items/a;    # MARKER: R8 Lcom/aspiro/wamp/playlist/ui/items/a; c
    if-eqz v3, :done
    invoke-interface {v3}, Lcom/aspiro/wamp/playlist/ui/items/a;->k()Lcom/aspiro/wamp/playlist/viewmodel/PlaylistCollectionViewModel;    # MARKER: R8 Lcom/aspiro/wamp/playlist/ui/items/a; k
    move-result-object v3
    ...
    move-result-object v3
    if-eqz v3, :done
    iget-object v4, v2, Lcom/aspiro/wamp/playlist/ui/items/PlaylistItemCollectionView;->h:Lcom/tidal/android/navigation/NavigationInfo;    # MARKER: R8 h
    ...
    move-result-object v4
    :member_nav_ready
    invoke-static {v3, v4}, Lcom/aspiro/wamp/playqueue/source/model/b;->f(Lcom/aspiro/wamp/model/Playlist;Lcom/tidal/android/navigation/NavigationInfo;)Lcom/aspiro/wamp/playqueue/source/model/PlaylistSource;    # MARKER: R8 Lcom/aspiro/wamp/playqueue/source/model/b; f
    move-result-object v7
    invoke-virtual {v7, v1}, Lcom/aspiro/wamp/playqueue/source/model/Source;->addSourceItem(Lcom/aspiro/wamp/model/MediaItem;)V
    ...
    invoke-static {v3, v1, v6, v7}, Lradiant/gestures/queue/QueueExecutor;->playNextTrack(Landroid/content/Context;Lcom/aspiro/wamp/model/Track;Lcom/aspiro/wamp/eventtracking/model/ContextualMetadata;Lcom/aspiro/wamp/playqueue/source/model/Source;)Z

    goto :done

    :append_track
    invoke-static {v3, v1, v6, v7}, Lradiant/gestures/queue/QueueExecutor;->track(Landroid/content/Context;Lcom/aspiro/wamp/model/Track;Lcom/aspiro/wamp/eventtracking/model/ContextualMetadata;Lcom/aspiro/wamp/playqueue/source/model/Source;)Z
    goto :done

    :add_to_playlist
    invoke-static {v3, v1, v6, v7}, Lradiant/gestures/queue/QueueExecutor;->addToPlaylistTrack(Landroid/content/Context;Lcom/aspiro/wamp/model/Track;Lcom/aspiro/wamp/eventtracking/model/ContextualMetadata;Lcom/aspiro/wamp/playqueue/source/model/Source;)V
    goto :done
    ...
    invoke-interface {v3, v1}, Lcom/aspiro/wamp/playlist/ui/items/a;->c(Lcom/aspiro/wamp/model/Track;)V    # MARKER: R8 Lcom/aspiro/wamp/playlist/ui/items/a; c
    goto :done

    :play_member
    invoke-direct {p0, p1}, Lradiant/gestures/queue/PlaylistItemsResolver;->playlistIndex(Lradiant/gestures/queue/QueueRequest;)I
    move-result v0
    if-gez v0, :start_member
    goto :done
    :start_member
    invoke-interface {v3, v0}, Lcom/aspiro/wamp/playlist/ui/items/a;->i(I)V    # MARKER: R8 Lcom/aspiro/wamp/playlist/ui/items/a; i
...
.method public resolve(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)Lradiant/gestures/queue/QueueRequest;
    ...
    instance-of v1, p1, La50/b;    # MARKER: R8 La50/b;
    if-eqz v1, :invalid
    ...
    instance-of v1, p2, Lij/q$a;    # MARKER: R8 Lij/q$a;
    ...
    :podcast_holder
    instance-of v1, p2, Lij/a0$a;    # MARKER: R8 Lij/a0$a;
    ...
    :suggestion_holder
    instance-of p2, p2, Lij/j0$a;    # MARKER: R8 Lij/j0$a;
    if-eqz p2, :invalid
    instance-of p2, p1, Lcom/aspiro/wamp/playlist/viewmodel/item/SuggestedTrackViewModel;
    if-eqz p2, :invalid

    :create
    invoke-static {p1}, Lradiant/gestures/queue/PlaylistItemsResolver;->track(Ljava/lang/Object;)Lcom/aspiro/wamp/model/Track;
    ...
    invoke-direct {p0, v2}, Lradiant/gestures/queue/PlaylistItemsResolver;->current(Lradiant/gestures/queue/QueueRequest;)Ljava/lang/Object;
    move-result-object p1
    if-eqz p1, :invalid
    return-object v2
