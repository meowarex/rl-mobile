.class public final Lradiant/gestures/queue/SearchAlbumsResolver;
...
.method private constructor <init>(Lcom/aspiro/wamp/mycollection/subpages/albums/search/SearchAlbumsView;)V
    ...
    iput-object v0, p0, Lradiant/gestures/queue/SearchAlbumsResolver;->fragment:Ljava/lang/ref/WeakReference;
...
.method private current(Lradiant/gestures/queue/QueueRequest;)Lzc/a;    # MARKER: R8 Lzc/a;
    ...
    iget-object v0, p0, Lradiant/gestures/queue/SearchAlbumsResolver;->fragment:Ljava/lang/ref/WeakReference;
    ...
    iget-object v1, v0, Lcom/aspiro/wamp/mycollection/subpages/albums/search/SearchAlbumsView;->f:Lid/e;    # MARKER: R8 Lid/e; f

    if-eqz v1, :invalid

    invoke-virtual {v0}, Lcom/aspiro/wamp/mycollection/subpages/albums/search/SearchAlbumsView;->N()La50/d;    # MARKER: R8 La50/d; N
...
.method public static install(Lcom/aspiro/wamp/mycollection/subpages/albums/search/SearchAlbumsView;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    new-instance v0, Lradiant/gestures/queue/SearchAlbumsResolver;

    invoke-direct {v0, p0}, Lradiant/gestures/queue/SearchAlbumsResolver;-><init>(Lcom/aspiro/wamp/mycollection/subpages/albums/search/SearchAlbumsView;)V
...
.method public execute(Lradiant/gestures/queue/QueueRequest;)V
    ...
    invoke-direct {p0, p1}, Lradiant/gestures/queue/SearchAlbumsResolver;->current(Lradiant/gestures/queue/QueueRequest;)Lzc/a;    # MARKER: R8 Lzc/a;
    ...
    iget-object v1, v0, Lcom/aspiro/wamp/mycollection/subpages/albums/search/SearchAlbumsView;->c:Lld/c;    # MARKER: R8 Lld/c; c

    if-eqz v1, :done

    iget-object v2, v1, Lld/c;->a:Lx40/a;    # MARKER: R8 Lld/c; Lx40/a; a
    ...
    iget-object v5, v1, Lld/c;->d:Lcom/aspiro/wamp/eventtracking/model/ContextualMetadata;    # MARKER: R8 Lld/c; d

    iget-object p0, v1, Lld/c;->c:Lcom/tidal/android/navigation/NavigationInfo;    # MARKER: R8 Lld/c; c
    ...
    iget-object v0, v0, Lcom/aspiro/wamp/mycollection/subpages/albums/search/SearchAlbumsView;->g:Lio/reactivex/disposables/CompositeDisposable;    # MARKER: R8 g
...
.method public resolve(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)Lradiant/gestures/queue/QueueRequest;
    ...
    instance-of v0, p2, Ljd/d$a;    # MARKER: R8 Ljd/d$a;
