.class public final Lradiant/gestures/queue/MyPlaylistsResolver;
...
.method private constructor <init>(Lcom/aspiro/wamp/mycollection/subpages/playlists/myplaylists/MyPlaylistsView;)V
    ...
    iput-object v0, p0, Lradiant/gestures/queue/MyPlaylistsResolver;->fragment:Ljava/lang/ref/WeakReference;
...
.method private current(Lradiant/gestures/queue/QueueRequest;)Lcf/b;    # MARKER: R8 Lcf/b;
    ...
    iget-object v1, p0, Lradiant/gestures/queue/MyPlaylistsResolver;->fragment:Ljava/lang/ref/WeakReference;
    ...
    iget-object v2, v1, Lcom/aspiro/wamp/mycollection/subpages/playlists/myplaylists/MyPlaylistsView;->j:Lcom/aspiro/wamp/mycollection/subpages/playlists/myplaylists/h;    # MARKER: R8 Lcom/aspiro/wamp/mycollection/subpages/playlists/myplaylists/h; j

    if-eqz v2, :invalid

    invoke-virtual {v1}, Lcom/aspiro/wamp/mycollection/subpages/playlists/myplaylists/MyPlaylistsView;->N()La50/d;    # MARKER: R8 La50/d; N
...
.method public static install(Lcom/aspiro/wamp/mycollection/subpages/playlists/myplaylists/MyPlaylistsView;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    new-instance v0, Lradiant/gestures/queue/MyPlaylistsResolver;

    invoke-direct {v0, p0}, Lradiant/gestures/queue/MyPlaylistsResolver;-><init>(Lcom/aspiro/wamp/mycollection/subpages/playlists/myplaylists/MyPlaylistsView;)V
...
.method public execute(Lradiant/gestures/queue/QueueRequest;)V
    ...
    iget v5, p1, Lradiant/gestures/queue/QueueRequest;->action:I

    invoke-direct {p0, p1}, Lradiant/gestures/queue/MyPlaylistsResolver;->current(Lradiant/gestures/queue/QueueRequest;)Lcf/b;    # MARKER: R8 Lcf/b;

    move-result-object p1

    if-eqz p1, :done

    iget-object v0, p0, Lradiant/gestures/queue/MyPlaylistsResolver;->fragment:Ljava/lang/ref/WeakReference;
    ...
    iget-object v1, v0, Lcom/aspiro/wamp/mycollection/subpages/playlists/myplaylists/MyPlaylistsView;->d:Lhf/c;    # MARKER: R8 Lhf/c; d
    ...
    iget-object v4, v1, Lhf/c;->e:Lcom/aspiro/wamp/eventtracking/model/ContextualMetadata;    # MARKER: R8 Lhf/c; e

    iget-object p0, v1, Lhf/c;->d:Lcom/tidal/android/navigation/NavigationInfo;    # MARKER: R8 Lhf/c; d
...
.method public resolve(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)Lradiant/gestures/queue/QueueRequest;
    ...
    instance-of v0, p2, Ldf/d$a;    # MARKER: R8 Ldf/d$a;
