.class public final Lradiant/gestures/queue/FavoriteTracksResolver;
...
.method private constructor <init>(Lcom/aspiro/wamp/mycollection/subpages/favoritetracks/FavoriteTracksFragment;)V
    ...
    iput-object v0, p0, Lradiant/gestures/queue/FavoriteTracksResolver;->fragment:Ljava/lang/ref/WeakReference;
...
.method public static install(Lcom/aspiro/wamp/mycollection/subpages/favoritetracks/FavoriteTracksFragment;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    new-instance v0, Lradiant/gestures/queue/FavoriteTracksResolver;

    invoke-direct {v0, p0}, Lradiant/gestures/queue/FavoriteTracksResolver;-><init>(Lcom/aspiro/wamp/mycollection/subpages/favoritetracks/FavoriteTracksFragment;)V
...
.method public execute(Lradiant/gestures/queue/QueueRequest;)V
    ...
    iget-object v0, p0, Lradiant/gestures/queue/FavoriteTracksResolver;->fragment:Ljava/lang/ref/WeakReference;
    ...
    iget-object v2, p1, Lradiant/gestures/queue/QueueRequest;->media:Ljava/lang/Object;

    check-cast v2, Lcom/aspiro/wamp/model/FavoriteTrack;

    iget p1, p1, Lradiant/gestures/queue/QueueRequest;->action:I

    invoke-virtual {v0, v1, v2, p1}, Lcom/aspiro/wamp/mycollection/subpages/favoritetracks/FavoriteTracksFragment;->Z(ILcom/aspiro/wamp/model/FavoriteTrack;I)V    # MARKER: R8 Z
...
.method public resolve(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)Lradiant/gestures/queue/QueueRequest;
    ...
    instance-of p1, p2, Ln8/d;    # MARKER: R8 Ln8/d;
    ...
    :has_position
    check-cast p2, Ln8/d;    # MARKER: R8 Ln8/d;

    iget-object p2, p2, Ln8/d;->f:Lcom/aspiro/wamp/model/MediaItem;    # MARKER: R8 Ln8/d; f
    ...
    invoke-virtual {v0, p1, p2}, Lcom/aspiro/wamp/mycollection/subpages/favoritetracks/FavoriteTracksFragment;->Y(ILcom/aspiro/wamp/model/FavoriteTrack;)Z    # MARKER: R8 Y
    ...
    invoke-direct {v1, p1, p2, v0}, Lradiant/gestures/queue/QueueRequest;-><init>(ILjava/lang/Object;I)V
